...
//   /* 🔥 Load table WITH occurrence count + time range */
...
//   return (
//     <Card title="Top Problems (Occurrence + Time Range)">
//       <Row gutter={16}>
//         <Col span={6}>
//           <Select
//             mode="multiple"
...
//               setTimeRange({
//                 time_from: dayjs(`${startDate} ${startTime}`).unix(),
//                 time_till: dayjs(`${endDate} ${endTime}`).unix(),
//               });
//             }}
//           />
//         </Col>
