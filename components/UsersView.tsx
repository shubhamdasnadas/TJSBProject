...
export const UsersView: React.FC<UsersViewProps> = ({
  ...
  // Bulk CSV parser for format: Full Name,Status,Email Address,Department,HOD (Auto),Role / Job Title
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50 border-b">
                  ...
                  <th className="p-4 font-semibold text-slate-600">EmpCode</th>
                  ...
                  filteredUsers.map(item => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-slate-50">
                        ...
                        <td className="p-4 font-mono text-slate-700">{item.empCode || '—'}</td>
                        <td className="p-4">
