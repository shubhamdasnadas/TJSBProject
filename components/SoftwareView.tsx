                            ...
                            <form id="software-form" onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-6 border-t">
                                    ...
                                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 mb-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        ...
                                        <div className="flex items-end gap-2"><input type="date" className="flex-1 border p-2 rounded-lg bg-white" value={selectedDateToAdd} onChange={e => setSelectedDateToAdd(e.target.value)} /><button type="button" onClick={handleAddUser} disabled={!selectedUserToAdd} className="bg-blue-600 text-white px-2 py-2 rounded-lg font-bold disabled:opacity-50">Assign</button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
